...
| 版本 | 文档 | 内容 | 状态 |
|------|------|------|------|
| v0.0 | [实施计划](v0.0/01-plan.md) | Skill 展示 + Symlink 管理，架构骨架完整 | 待开发 |
| v0.1 | [实施计划](v0.1/01-plan.md) | 完整功能：拖拽、撤销、批量、i18n、主题、设置 | 待开发 |
...
├── v0.0/
│   └── 01-plan.md           ← v0.0 先行版计划
└── v0.1/
    └── 01-plan.md           ← v0.1 完整版计划
```
